...
// 		if err != nil {
// 			xlog.Logger.WithField("err", err).Error("execute event action error! event:" + convertor.ToJsonString(message))
// 			return false
// 		}
// 	}
// 	return true
...
// 	// if err := websocket.Message.Send(w.wsHandler, convertor.ToJsonString(message)); err != nil {
